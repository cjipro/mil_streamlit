...
Next ticket: PULSE-129 (PULSE-128 = engine relocation into while-sleeping, 2026-05-22; the full Pulse vertical — pipeline → decisions → lineage → fairness → audit → CHRONICLE — built under PULSE-128 with PULSE-28/34/39 re-scoped to DuckDB. PULSE-110/113-127 also exist from the holter data-layer/detection work. "PULSE-1 through PULSE-91" above is design-spine history, not the live high-water mark.)
Board: Scrum
