...
- **Apr 25 — website-chain admin steps (none blocking ship)**:
  - **MIL-82 DNS reservations** — Cloudflare dashboard → cjipro.com → DNS → add `app` AAAA `100::` proxied + `admin` AAAA `100::` proxied. ~30 seconds. See `ops/runbooks/mil-82_dns_prep.md` Mode B.
