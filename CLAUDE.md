...
| MIL-60 | WorkOS account + custom domain mapping | BACKLOG — runbook at `ops/runbooks/mil-60_workos_setup.md` (commit `ee403b7`); Hussain admin work |
| MIL-61 | Cloudflare Worker Edge Bouncer (JWT cookie check + route whitelist + WorkOS redirect) | BACKLOG (depends on MIL-60 values) |
